...
## Purpose
Governs container packaging, multi-stage Linux builds, Prisma Query Engine generation, runtime security, health probing, and external database/cache connectivity.

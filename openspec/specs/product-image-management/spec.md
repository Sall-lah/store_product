# Product Image Management Specification

## Purpose
Governs administrative media operations including direct-to-R2 presigned upload URL generation, image registration, gallery sequencing, metadata updates, and object deletion.
